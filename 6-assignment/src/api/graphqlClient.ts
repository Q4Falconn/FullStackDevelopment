// Use Next.js public environment variables when available.  We fall back to
// the same localhost endpoint that was used in the original Vite app.
const GRAPHQL_HTTP_URL = process.env.NEXT_PUBLIC_GRAPHQL_HTTP_URL ?? 'http://localhost:4000/graphql'
